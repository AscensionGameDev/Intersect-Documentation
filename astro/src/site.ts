...
export const SITE: Site = {
    ...
    repository: {
        type: 'git',
        baseUrl: new URL('https://github.com/AscensionGameDev/Intersect-Documentation/tree/main/src/content/docs')
    },
    communityUrl: new URL('https://discord.gg/qaJ8kRmdKA'),
    editUrl: new URL('https://github.com/AscensionGameDev/Intersect-Documentation/tree/main/src/content/docs'),
    'en-US': {
