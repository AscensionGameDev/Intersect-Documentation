...
You will be greeted with this Astro start-up console, which includes the link to the [running development server](http://localhost:3000):

![Astro start-up console](.github/assets/getting-started-astro.png)
