...
- *Hit Animation*: You can select a hit animation that will play on the target. If you don't have any animations created, refer to the `Animation Editor` in the `Game Editors` tab on the main interface.
